// File: ArrayBag<E>.java from the package edu.colorado.collections
// Additional javadoc documentation is available from the ArrayBag<E> link in:
//   http://www.cs.colorado.edu/~main/docs

/******************************************************************************
* An ArrayBag<E> is a collection of <E> objects.
...
*
* @see
*   <A HREF="../../../../edu/colorado/collections/ArrayBag<E>.java">
*   Java Source Code for this class
*   (www.cs.colorado.edu/~main/edu/colorado/collections/ArrayBag<E>.java)
*   </A>
*
* @author Michael Main 
...
{
   // Invariant of the ArrayBag<E> class:
   ...
   **/
   ...
   /**
    * Add a new element to this bag in given position. If the new element would take this
    * bag beyond its current capacity, then the capacity is increased
    * before adding the new element.
    * @param element
    *   the new element that is being inserted
   ...
   **/
   public int countOccurrences(E target)
   {
      ...
      { // use target.equals to determine how many items
	      for (index = 0; index < manyItems; index++)
   ...
   **/
   ...
   public E getObject (int position){
	   ...
	   if (position >= getCapacity())
		   throw new IllegalArgumentException  ("The object you are trying to retrive does not exist!");
